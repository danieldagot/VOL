...
- Card tokens (est. `cl100k_base`): Python=336, VOL=316
...
| VOL | 100.0 | 100.0 | 670 | 685.5 ± 83.7 | 15 |
...
| VOL | 599.8 | 85.7 | 685.5 | 87.5% | 12.5% |

## VOL vs Python token deltas (cold means)

| Metric | VOL vs Python |
| --- | --- |
| Generated completion tokens | -36.3% |
| Prompt tokens | -4.3% |
| Total workflow tokens (cold) | -10.0% |
| Abs. prompt delta / task-replicate | -27.0 |
| Abs. completion delta / task-replicate | -48.9 |
...
| VOL | 685.5 | 369.5 | -316.0 | 316 |

Warm VOL vs Python total: -13.1% (means 369.5 vs 425.3).
...
| generation | VOL | 100.0 | 624.6 | 554.7 | 69.9 | 9 |
| modification | Python | 100.0 | 956.0 | 679.0 | 277.0 | 3 |
| modification | VOL | 100.0 | 804.7 | 624.0 | 180.7 | 3 |
| repair | Python | 100.0 | 771.0 | 728.0 | 43.0 | 3 |
| repair | VOL | 100.0 | 749.0 | 711.0 | 38.0 | 3 |
...
| 08-strings-assert | vol | 1 | R007 | True | True | 1 | 749 | success |
| 08-strings-assert | vol | 2 | R007 | True | True | 1 | 749 | success |
| 08-strings-assert | vol | 3 | R007 | True | True | 1 | 749 | success |
...
| 06-where-sum | generation | vol | 1 | True | True | 1 | 572 | 526 | 46 | 256 | success |
| 06-where-sum | generation | vol | 2 | True | True | 1 | 572 | 526 | 46 | 256 | success |
| 06-where-sum | generation | vol | 3 | True | True | 1 | 572 | 526 | 46 | 256 | success |
| 14-pipeline-stats | generation | vol | 1 | True | True | 1 | 669 | 584 | 85 | 353 | success |
| 14-pipeline-stats | generation | vol | 2 | True | True | 1 | 693 | 584 | 109 | 377 | success |
| 14-pipeline-stats | generation | vol | 3 | True | True | 1 | 670 | 584 | 86 | 354 | success |
| 16-map-filter | generation | vol | 1 | True | True | 1 | 625 | 554 | 71 | 309 | success |
| 16-map-filter | generation | vol | 2 | True | True | 1 | 623 | 554 | 69 | 307 | success |
| 16-map-filter | generation | vol | 3 | True | True | 1 | 625 | 554 | 71 | 309 | success |
| 08-strings-assert | repair | vol | 1 | True | True | 1 | 749 | 711 | 38 | 433 | success |
| 08-strings-assert | repair | vol | 2 | True | True | 1 | 749 | 711 | 38 | 433 | success |
| 08-strings-assert | repair | vol | 3 | True | True | 1 | 749 | 711 | 38 | 433 | success |
| 11-leaderboard | modification | vol | 1 | True | True | 1 | 802 | 624 | 178 | 486 | success |
| 11-leaderboard | modification | vol | 2 | True | True | 1 | 806 | 624 | 182 | 490 | success |
| 11-leaderboard | modification | vol | 3 | True | True | 1 | 806 | 624 | 182 | 490 | success |
